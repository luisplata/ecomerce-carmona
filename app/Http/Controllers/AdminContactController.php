<?php namespace App\Http\Controllers;
	...
	class AdminContactController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Mail","name"=>"mail","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:contact","placeholder"=>"Introduce una dirección de correo electrónico válida"];
			# OLD END FORM
